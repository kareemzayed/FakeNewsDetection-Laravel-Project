...
<head>
    ...
    <!-- Basic Page Info -->
    <meta charset="utf-8">
    <title>Fake News Detector | 2FA</title>
    <!-- Favicon -->
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 col-lg-7">
                    <img src="{{ asset('Dashboard-assets') }}/vendors/images/two-factor-auth.png" alt="" style="width: 600px">
                </div>
                <div class="col-md-6 col-lg-5">
                    <div class="login-box bg-white box-shadow border-radius-10">
                        <div class="login-title">
                            <h2 class="text-center text-primary">2F Authentication</h2>
                        </div>
                        ...
                        <form method="POST" action="{{ route('two-factor.login') }}">
                            ...
                            <label for="code"
                                style="color:darkslategrey; font-size:17px;">{{ __('Please enter your OTP to login') }}</label>
                            <div class="input-group custom">
                                <input id="code" type="code"
                                    class="form-control form-control-lg @error('code') is-invalid @enderror"
                                    name="code" required autofocus placeholder="Code">
                                @error('code')
                            ...
                            <div class="already-have-account"><a class="btn btn-link" style="font-size: 15px"
                                    href="{{ route('login') }}">Back to login</a></div>
                        </form>
                    </div>
                </div>
            </div>
